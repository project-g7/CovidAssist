...
import { StyleSheet, View, Button, SafeAreaView, ScrollView,TouchableOpacity,FlatList } from 'react-native'
            ...
            <View style={styles.userInfoSection}>
                <ScrollView style={styles.scrollView}>
                    ...
                    <View>
                      ...
                      {data.map((val)=>{
                          return(
                            <Text key={val.first_name} style={styles.caption}>{val.first_name}</Text>
                          );
                      })}
                    </View>
                    <View style={{marginTop:'5%'}}>
                        ...
                        {data.map((val)=>{
                          return(
                            <Text key={val.last_name} style={styles.caption}>{val.last_name}</Text>
                          );
                      })}
                    </View>
                    <View style={{marginTop:'5%'}}>
                        ...
                        {data.map((val)=>{
                          return(
                            <Text key={val.nic} style={styles.caption}>{val.nic}</Text>
                          );
                      })}
                    </View>
                    <View style={{marginTop:'5%'}}>
                        ...
                        {data.map((val)=>{
                          return(
                            <Text key={val.contact_number} style={styles.caption}>{val.contact_number}</Text>
                          );
                      })}
                    </View>
                    <View style={{marginTop:'5%'}}>
                        ...
                        {data.map((val)=>{
                          return(
                            <Text key={val.email} style={styles.caption}>{val.email}</Text>
                          );
                      })}
                    </View>
                    <View style={{marginTop:'5%'}}>
                        ...
                        {data.map((val)=>{
                          return(
                            <Text key={val.user_name} style={styles.caption}>{val.user_name}</Text>
                          );
                      })}
                    </View>
            <View style={{alignItems:'center'}}>
                <View style={{width:'40%', alignItems:'center'}}>
                          {/* <TouchableOpacity */}
                            ...
                            {data.map((val)=>{
                          return(
                            <TouchableOpacity key={val.first_name} onPress={() => navigation.navigate('EditProfile', {
