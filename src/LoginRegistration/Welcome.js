  ...
  render(navigation) {
    return (
      <View style={styles.view}>
        ...
        <Text style={styles.bodyText}>
          Every instance of close contact between you and other CovidAssit users
          is noted to create contact data. This information is encrypted and
          only stored in your phone.
        </Text>
        <Text style={styles.bodyText}>
        ...
        <Text style={styles.bodyText}>
          CovidAssit can also inform you with alert if you came in close contact
          with another CovidAssit user who tested positive.
        </Text>
        <TouchableOpacity  onPress={() => this.props.navigation.navigate('Welcome2')}>
